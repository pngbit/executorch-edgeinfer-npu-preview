...
def define_common_targets():
    ...
    runtime.cxx_test(
        name = "test_qnn_delegate_handle_registry",
        srcs = ["test/test_qnn_delegate_handle_registry.cpp"],
        deps = [
            ":runtime",
        ],
    )
    ...
    runtime.cxx_test(
        name = "test_qnn_dlc_manager_lifecycle",
        srcs = ["test/test_qnn_dlc_manager_lifecycle.cpp"],
        headers = ["backends/QnnDlcResourceLifecycle.h"],
    )
