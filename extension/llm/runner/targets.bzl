...
def define_common_targets():
    ...
    for aten in get_aten_mode_options():
        ...
        runtime.cxx_library(
            name = "composable_attention_runner" + aten_suffix,
            exported_headers = [
                "causal_attention_block.h",
                "composable_attention_runner.h",
                "edgeinfer_decode_cache_transaction.h",
                "static_attention_planner.h",
            ],
            srcs = [
                "composable_attention_runner.cpp",
                "static_attention_planner.cpp",
            ],
            visibility = ["PUBLIC"],
            exported_deps = [
                "//executorch/extension/module:module" + aten_suffix,
